	...
	public void jogar2() {
		...
		public void verificar() {
			if (totalpontos[0] > totalpontos[1]) {
				JOptionPane.showMessageDialog(null, "O Jogador 1: "+ nomes[0] + " é o Vencedor!");
			}else {
				JOptionPane.showMessageDialog(null, "O Jogador 2: " + nomes[1] + " é o Vencedor!");
			}
		}
		public void menu() {
			valorPosicoes();
